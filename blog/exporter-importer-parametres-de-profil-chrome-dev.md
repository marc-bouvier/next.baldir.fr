...
Ici je souhaite récupérer les paramètres d'appareils émulés dans les [outils-de-developpeur-chromium](glossaire/outils-de-developpeur-chromium.md) pour simuler des appareils mobiles.
