...
[HID macros](http://hidmacros.eu/) is a tool that can bind keys to commands on Windows.
It can differentiate between keyboards so there won't be conflicts between multiple keyboards.
